...
14. [Lessons Learned / Gotchas](#lessons-learned--gotchas)
...
Confirm memory locking took effect:
...
Expected result: cluster info JSON and a `_cat/nodes` table with a single active node.
...
Expected result: TLS handshake OK (TLSv1.3) and "talk to server... OK".
